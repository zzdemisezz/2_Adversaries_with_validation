...
def train_pipeline(data, sens_feature, backend, debiased=True, multiple=False):
    ...
    clf = AdversarialDebiasing([sens_feature], adversary_loss_weight=0.01, num_epochs=n_epoch, batch_size=256,
    ...
    #deo = DifferenceEqualOpportunity(y_pred, y_val, sens_feature, classification, 1, 0, [0, 1])
